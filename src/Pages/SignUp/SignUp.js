            ...
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10">
                    ...
                    <form onSubmit={handleSubmit(handleSignUp)}>
                        <div >
                            <label className="text-sm font-medium leading-none text-gray-800">Your Name</label>
                            <input {...register("name", { required: "Name is required" })} type="text" name='name' className="bg-gray-50 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                        ...
                        <div className="mt-3  w-full">
                            ...
                            <input {...register("email", { required: "Email Address is required" })} type="email" className="bg-gray-50 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                            {errors.email && <p role="alert" className='text-red-700 text-xs'>{errors.email?.message}</p>}
                        </div>
                        <div className="mt-3  w-full">
                            ...
                            <div className="relative flex items-center justify-center">
                                ...
                                })} type="password" className="bg-gray-50 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
